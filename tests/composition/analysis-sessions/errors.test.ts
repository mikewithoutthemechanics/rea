...
const expectSecretsHidden = (serialized: string): void => {
  for (const hidden of [
    "secret-token",
    "AnalysisCapabilityUnavailableError",
    "declaredSha256",
...
describe("analysis error projection: typed failures", () => {
  it("projects every typed failure without secrets", () => {
    ...
    expectSecretsHidden(serialized);
...
describe("analysis error projection: contract variants", () => {
